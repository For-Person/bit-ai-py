...
# model = CatBoostClassifier(n_estimators=3649, depth=8, 
#                            fold_permutation_block=113, 
#                            learning_rate=0.7675787352245581, 
#                            od_pval=0.23377950009657333, 
#                            l2_leaf_reg=1.6816646505161206, 
#                            random_state=646)
