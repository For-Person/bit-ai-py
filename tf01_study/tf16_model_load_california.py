...
# model.save('./_save/tf15_california.h5') # h5로 모델 저장, HDF5 포맷으로 데이터를 저장한다는 의미
...
model = load_model('./_save/tf16_california.h5') # 저장한 모델 불러오기
...
# loss :  0.6173481941223145
# r2 스코어 :  0.5418216320121594
# 걸린시간 :  16.033483266830444